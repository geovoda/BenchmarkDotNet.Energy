        ...
        public class CustomEngine : IEngine
        {
            public RunResults Run()
            {
                ...
                return new RunResults(
                    ...
                    {
                        new(1, IterationMode.Overhead, IterationStage.Actual, 1, 1, 1, new List<EnergyMeasurement>()),
                        new(1, IterationMode.Workload, IterationStage.Actual, 1, 1, 1, new List<EnergyMeasurement>())
                    },
