...
namespace BenchmarkDotNet.Diagnosers
{
    public class MetrionEnergyProfilerConfig
    {
        ...
        /// <param name="keepMetrionFiles">When set to true, the files generated by Metrion will be stored in the Artifacts folder. When set to false, the Metrion files will be deleted after energy extraction. False by default.</param>
        ...
        public MetrionEnergyProfilerConfig(string metrionBinaryPath, string metrionDatabaseDirectory, string metrionDatabaseNamePattern="monitor*.db", bool keepMetrionFiles = false, bool performExtraBenchmarksRun = false, int timeoutInSeconds = 300, bool measurePerIteration = false, IntPtr? affinityMask = null )
        {
            ...
            KeepMetrionFiles = keepMetrionFiles;
        ...
        public bool KeepMetrionFiles { get; }
