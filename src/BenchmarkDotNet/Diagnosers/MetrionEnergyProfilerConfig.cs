...
namespace BenchmarkDotNet.Diagnosers
{
    public class MetrionEnergyProfilerConfig
    {
        ...
        public MetrionEnergyProfilerConfig(string metrionBinaryPath, string metrionDatabaseDirectory, string metrionDatabaseNamePattern="monitor*.db", bool keepMetrionDatabaseFiles = false, bool performExtraBenchmarksRun = false, int timeoutInSeconds = 300)
        {
